...
true if the string contains the letter 'w' in lower case or false
 if it does not. 
...
regular expression pattern to match all words that begin with a capital letter. It should only
