...
value using a for loop. Place the new value in a new array. Return the new array.
------------------------------------------------------------------------------------------------ */
...
const addTwo = (arr) => {
  ...
  for (let index = 0; index < arr.length; index++) {
    let valueEl = arr[index] + 2;
    newArry.push(valueEl);
  }
  return newArry;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let newArry = arr.filter(value => value.includes('and'));
  return newArry;
